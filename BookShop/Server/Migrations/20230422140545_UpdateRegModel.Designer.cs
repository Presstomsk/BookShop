...
namespace BookShop.Server.Migrations
{
    ...
    [Migration("20230422140545_UpdateRegModel")]
            ...
            modelBuilder.Entity("BookShop.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 4, 22, 14, 5, 44, 880, DateTimeKind.Utc).AddTicks(8399),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 4, 22, 14, 5, 44, 880, DateTimeKind.Utc).AddTicks(8409),
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 4, 22, 14, 5, 44, 880, DateTimeKind.Utc).AddTicks(8411),
