...
namespace BookShop.Server.Migrations
{
    ...
    [Migration("20230430142412_ChangeStats")]
            ...
            modelBuilder.Entity("BookShop.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 4, 30, 14, 24, 12, 127, DateTimeKind.Utc).AddTicks(7080),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 4, 30, 14, 24, 12, 127, DateTimeKind.Utc).AddTicks(7092),
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 4, 30, 14, 24, 12, 127, DateTimeKind.Utc).AddTicks(7095),
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 2,
                            DateCreated = new DateTime(2023, 4, 30, 14, 24, 12, 127, DateTimeKind.Utc).AddTicks(7097),
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 2,
                            DateCreated = new DateTime(2023, 4, 30, 14, 24, 12, 127, DateTimeKind.Utc).AddTicks(7099),
                        ...
                        new
                        {
                            Id = 6,
                            CategoryId = 3,
                            DateCreated = new DateTime(2023, 4, 30, 14, 24, 12, 127, DateTimeKind.Utc).AddTicks(7101),
            ...
            modelBuilder.Entity("BookShop.Shared.RegModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "Admin",
                            ConfirmPwd = "$2a$11$OtaI46cOKPgge153Yd1XxOfFaQMwGErFBXiWSQRJ2gItsu9ybmSGG",
                            Name = "Admin",
                            Password = "$2a$11$SR5VSWGcGdkzEtu6bwtR6Oil9ggIul5SE.TSGiPRlLBmtlX5ITgVm",
                            Role = 0,
                            Surname = "Admin"
                        });
                });
