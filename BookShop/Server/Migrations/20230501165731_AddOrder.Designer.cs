...
namespace BookShop.Server.Migrations
{
    ...
    [Migration("20230501165731_AddOrder")]
            ...
            modelBuilder.Entity("BookShop.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 5, 1, 16, 57, 30, 719, DateTimeKind.Utc).AddTicks(7189),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 5, 1, 16, 57, 30, 719, DateTimeKind.Utc).AddTicks(7196),
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 5, 1, 16, 57, 30, 719, DateTimeKind.Utc).AddTicks(7198),
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 2,
                            DateCreated = new DateTime(2023, 5, 1, 16, 57, 30, 719, DateTimeKind.Utc).AddTicks(7200),
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 2,
                            DateCreated = new DateTime(2023, 5, 1, 16, 57, 30, 719, DateTimeKind.Utc).AddTicks(7201),
                        ...
                        new
                        {
                            Id = 6,
                            CategoryId = 3,
                            DateCreated = new DateTime(2023, 5, 1, 16, 57, 30, 719, DateTimeKind.Utc).AddTicks(7202),
            ...
            modelBuilder.Entity("BookShop.Shared.RegModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "Admin",
                            ConfirmPwd = "$2a$11$0GtBKE2aTmI.tJ23Az7Ns.qCkQ/80biPTqi9uyzpa9EhGniv2jM6m",
                            Name = "Admin",
                            Password = "$2a$11$jVUtFy/XCA0vlrR25y8ySunXeeSYP7sr88EEsSRfCfCWZjI1SXTsO",
                            Role = 0,
                            Surname = "Admin"
                        });
                });
