...
namespace BookShop.Server.Migrations
{
    ...
    [Migration("20230413144334_Seeding")]
            ...
            modelBuilder.Entity("BookShop.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 4, 13, 14, 43, 34, 62, DateTimeKind.Utc).AddTicks(7115),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 4, 13, 14, 43, 34, 62, DateTimeKind.Utc).AddTicks(7124),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 4, 13, 14, 43, 34, 62, DateTimeKind.Utc).AddTicks(7126),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
